...
3. Authorized redirect URIs: add **every** client's callback URL. For each deployment:
   - `https://bot.<client-slug>.aiagencycorp.com/oauth/callback`
...
3. After deploying their stack, have them visit `https://bot.<client-slug>.aiagencycorp.com/admin`, log in, and click "Connect Gmail".
